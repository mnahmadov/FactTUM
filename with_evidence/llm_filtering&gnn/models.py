...
def get_bert_model(model_name="bert", include_classifier=True, num_labels=2, freeze_base_model=False,
    ...
    if include_classifier:
        model = AutoModelForSequenceClassification.from_pretrained(
            "/root/.cache/huggingface/hub/models--bert-base-uncased/snapshots/86b5e0934494bd15c9632b12f734a8a67f723594/", cache_dir="./cache", trust_remote_code=True, num_labels=num_labels,
            output_hidden_states=True
        )
    else:
        model = AutoModel.from_pretrained( "/root/.cache/huggingface/hub/models--bert-base-uncased/snapshots/86b5e0934494bd15c9632b12f734a8a67f723594/")
